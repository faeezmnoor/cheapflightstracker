...
class RunResult:
    ...
    # Fares from the far-horizon lane (two 30-day blocks, 3 and 5 months out)
    # that beat everything in the near window. Kept as its own list, never
    # merged into `deals`: those are "unusual for this route", these are
    # "cheaper to fly then", and the two claims must not share a section or a
    # baseline.
